      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap -mx-4 items-stretch mb-12 lg:mb-24">
          <div className="w-full lg:w-6/12 px-4 mb-8 lg:mb-0">
             <div ref={reveal1.ref} className={`bg-[#063326] p-12 md:p-16 h-full flex flex-col justify-center rounded-none text-white animeTexto ${reveal1.className}`}>
                <h2 className="text-4xl md:text-5xl font-voyage mb-8 leading-tight uppercase tracking-wider">Be free from toxic load</h2>
                <p className="text-gray-200 text-lg leading-relaxed mb-8 font-light font-sans">
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className={`h-full min-h-[400px] animeZoom ${reveal1.className} rounded-none shadow-2xl overflow-hidden`}>
              <img 
        ...
        {/* Bloco 2: Foto Esquerda, Texto Direita (Replicado e Invertido) */}
        <div className="flex flex-wrap -mx-4 items-stretch">
          <div className="w-full lg:w-6/12 px-4 order-2 lg:order-1">
            <div className={`h-full min-h-[400px] animeZoom ${reveal2.className} rounded-none shadow-2xl overflow-hidden`}>
              <img 
          ...
          <div className="w-full lg:w-6/12 px-4 order-1 lg:order-2 mb-8 lg:mb-0">
             <div ref={reveal2.ref} className={`bg-[#2D2926] p-12 md:p-16 h-full flex flex-col justify-center rounded-none text-white animeTexto ${reveal2.className}`}>
                <h2 className="text-3xl md:text-4xl font-voyage mb-8 leading-tight uppercase tracking-widest opacity-90">Renovação e Regeneração</h2>
