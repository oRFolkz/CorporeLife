...
export const ParallaxSection: React.FC<ParallaxSectionProps> = ({ 
  ...
  return (
    <div ref={containerRef} className="parallax-container rounded-none" style={{ height }}>
      <img ref={imgRef} src={image} className="parallax-img rounded-none" alt="Background Parallax" />
