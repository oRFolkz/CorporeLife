  ...
  return (
    <section className="py-24 bg-[#F4F9FF]">
      <div className="container mx-auto px-4">
        {/* Título no topo atualizado com efeito tipográfico */}
        <div ref={reveal.ref} className={`text-center mb-20 animeTexto ${reveal.className}`}>
          ...
          <div className="w-16 h-px bg-[#deb357] mx-auto mt-6 opacity-40"></div>
        </div>
        
        <div className="flex flex-wrap -mx-4 items-center">
          {/* Foto na esquerda (50% em desktop) */}
          ...
          {/* Cards em vertical na direita (50% em desktop) */}
